...
describe("toRoman()", () => {
  ...
  it("converts 16", () => expect(toRoman(16)).toEqual("XVI"));
  ...
  it("converts 66", () => expect(toRoman(66)).toEqual("LXVI"));
  ...
  it("converts 166", () => expect(toRoman(166)).toEqual("CLXVI"));
  it("converts 402", () => expect(toRoman(402)).toEqual("CDII"));
  it("converts 575", () => expect(toRoman(575)).toEqual("DLXXV"));
  it("converts 666", () => expect(toRoman(666)).toEqual("DCLXVI"));
  it("converts 911", () => expect(toRoman(911)).toEqual("CMXI"));
  it("converts 1024", () => expect(toRoman(1024)).toEqual("MXXIV"));
  it("converts 1666", () => expect(toRoman(1666)).toEqual("MDCLXVI"));
  it("converts 3000", () => expect(toRoman(3000)).toEqual("MMM"));
  it("converts 3001", () => expect(toRoman(3001)).toEqual("MMMI"));
  it("converts 3888", () => expect(toRoman(3888)).toEqual("MMMDCCCLXXXVIII"));
  it("converts 3999", () => expect(toRoman(3999)).toEqual("MMMCMXCIX"));
});
